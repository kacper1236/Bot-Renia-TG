...
with app.app_context():
    db.create_all()
    # howMuchTimeToConvention = Config(name='ile_do_futrolajek', value='621')
    # conventionDate = Config(name='data', value='6.2.1')
    # discordLink = Config(name='discord', value='abc')
    # websiteLink = Config(name='website', value='def')
